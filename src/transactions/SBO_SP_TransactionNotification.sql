...
IF :object_type = '13' AND (:transaction_type = 'A' OR :transaction_type = 'U') THEN
    ...
    WHERE 
        ...
        AND T0."BaseType" = '17' 
        AND T1."CANCELED" = 'N' 
        AND "Get_Pedido_Venda_Permissao_Faturamento"(T0."BaseEntry", T0."BaseLine", T0."Quantity") <> 'Ok';
    ...
    -- PAULO 09-09-2024
    -- VERIFICAÇÃO SE A NOTA É ENTREGA FUTURA. CASO POSITIVO, SÓ PERMITIR DESPESA ADICIONAL DE FRETE SIMPLES FATURAMENTO.
