...
FROM
	...
	SELECT
		T0."CardCode",
		T0."DocEntry" AS "DocEntry nota",
		T0."CardName" AS "Cliente",
		T2."DocNum" AS "Nº Pagamento#",
		T2."DocEntry" AS "DocEntryPagamento",
		T5."Price",
...
T1."DocTransId" = T0."TransId"
	...
	LEFT JOIN "RIN21" T6 ON
		T0."DocNum" = T6."RefDocNum"
		AND T6."RefDocNum" IS NULL
	LEFT JOIN "ORIN" T12 ON
		T6."DocEntry" = T12."DocEntry"
		AND T12."CANCELED" = 'N'
	LEFT JOIN "INV21" T9 ON
		T0."DocNum" = T9."RefDocNum"
...
UNION
	...
	LEFT JOIN "RIN21" T6 ON
		T0."DocNum" = T6."RefDocNum"
		AND T6."RefDocNum" IS NULL
	LEFT JOIN "ORIN" T13 ON
		T6."DocEntry" = T13."DocEntry"
		AND T13."CANCELED" = 'N'
	LEFT JOIN "INV21" T9 ON
		T0."DocNum" = T9."RefDocNum"
	LEFT JOIN "INV3" T8 ON
