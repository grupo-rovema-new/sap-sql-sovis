-- SBOGRUPOROVEMA.ASSPRAZOPAGTOEMPRESA fonte
...
SELECT
	 ...
	 (SELECT
	 T0."U_juros" - T0."U_desconto"
	FROM "@CONDICOESFV" T0 
	WHERE (T0."Code" || '_' || T0."U_prazo") = "IDPRAZOPAGTOERP") AS "REAJUSTE",
	 ...
	 0 AS "PRAZOMEDIO",
	 'N' AS "FLEXIVEL",
	 'N' AS "VALIDAPARCELASFLEXIVEL"
FROM prazopagto,empresa;