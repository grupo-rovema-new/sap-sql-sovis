-- SBOGRUPOROVEMA.PEDIDORETORNO fonte
...
SELECT DISTINCT
	...
	(SELECT	MAX("Usage") FROM QUT1	WHERE OQUT."DocEntry" = QUT1."DocEntry" )AS "IDTIPOPEDIDOERP",
	...
	SUBSTRING(OQUT."Comments",1,255) AS "OBSPEDIDO",
	SUBSTRING(CAST(fatura."Header" AS VARCHAR),1,255) AS "OBSNOTA",
	OQUT."DocTotal" AS "VALOR",
	(SELECT	MAX("DiscPrcnt") FROM QUT1	WHERE OQUT."DocEntry" = QUT1."DocEntry" ) AS "DESCONTO",
